...
void main() {
  ...
  group('Location Integration Tests', () {
    ...
    testWidgets('LocationService works with real GPS when permissions granted', (tester) async {
      ...
      if (position != null) {
        ...
        expect(position, isNull, reason: 'Location service unavailable or permissions denied');
      }
    });
    ...
    testWidgets('App initializes and handles location services', (tester) async {
      // Start the app
      app.main();
    ...
    testWidgets('LocationService handles permission scenarios gracefully', (tester) async {
